  ...
  return (
    <div className="code-block relative overflow-hidden">
      ...
      {visibleLines < CODE_LINES.length && (
        <span
          className="inline-block w-2 h-4 bg-forge-500 ml-1"
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0e1a] ambient-glow">
      {/* ── Nav ─────────────────────────────── */}
      <nav className="relative z-10 border-b border-white/[0.06] px-6 py-4 backdrop-blur-sm bg-[#0a0e1a]/80">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-forge-400 to-forge-600 flex items-center justify-center text-sm font-bold shadow-lg shadow-forge-500/20">
              ⚡
            </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <Link
              href="/builder"
              className="px-4 py-2 bg-gradient-to-r from-forge-500/15 to-blue-500/10 border border-forge-500/30 rounded-lg text-forge-400 text-xs font-mono font-semibold hover:bg-forge-500/20 hover:border-forge-400/40 transition-all"
            >
              Open Builder →
            </Link>
          </div>
      ...
      <section className="relative z-10 px-6 pt-24 pb-20">
        ...
        <div className="absolute bottom-0 left-[40%] w-[300px] h-[300px] rounded-full bg-purple-500/[0.03] blur-[80px] pointer-events-none" />
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="flex gap-4">
              <Link
                href="/builder"
                className="px-6 py-3 bg-gradient-to-r from-forge-500 to-emerald-400 hover:from-forge-400 hover:to-emerald-300 text-white font-mono font-semibold text-sm rounded-lg transition-all glow-green"
              >
                Start Building →
              </Link>
              <a
                href="https://github.com/mpalmer79/mcp-forge"
                className="px-6 py-3 bg-white/[0.04] border border-white/[0.1] hover:border-white/[0.2] hover:bg-white/[0.06] text-slate-300 font-mono text-sm rounded-lg transition-all"
                target="_blank"
                rel="noopener noreferrer"
              >
                View Source
      ...
      {/* ── Stats ───────────────────────────── */}
      <section className="relative z-10 px-6 py-14 border-y border-white/[0.06]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {FEATURES.map((f) => (
              <div key={f.title} className="feature-card group">
                {/* Photo background - lighter overlay */}
                <img
                  src={f.photo}
                  alt=""
                  className="card-bg"
                  loading="lazy"
                />
                {/* Color-tinted gradient overlay instead of solid dark */}
                <div
                  className={`absolute inset-0 bg-gradient-to-t ${f.gradient}`}
                  style={{ zIndex: 1 }}
                />
                <div
                  className="absolute inset-0 bg-gradient-to-t from-[#0d1225]/95 via-[#0d1225]/75 to-[#0d1225]/40"
                  style={{ zIndex: 1 }}
                />

                {/* Content */}
                <div className="relative p-7 pt-28" style={{ zIndex: 2 }}>
      ...
      {/* ── MCP Explanation ─────────────────── */}
      <section className="relative z-10 px-6 py-20 border-t border-white/[0.06]">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex justify-center gap-6 text-[11px] font-mono text-slate-500">
            <span>JSON-RPC 2.0</span>
            <span className="text-forge-500/40">{"\u00B7"}</span>
      ...
      <section className="relative z-10 px-6 py-24 border-t border-white/[0.06]">
        ...
        <div className="relative max-w-2xl mx-auto text-center">
          ...
          <Link
            href="/builder"
            className="inline-block px-8 py-4 bg-gradient-to-r from-forge-500 to-emerald-400 hover:from-forge-400 hover:to-emerald-300 text-white font-mono font-bold text-sm rounded-lg transition-all glow-green"
          >
            ⚡ Launch MCP Forge
          </Link>
        </div>
      ...
      <footer className="relative z-10 px-6 py-8 border-t border-white/[0.06]">
        <div className="max-w-6xl mx-auto flex items-center justify-between text-[10px] font-mono text-slate-500">
